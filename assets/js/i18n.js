...
window.PF_I18N = (function () {
  const dict = {
    ...
    en: {
      ...
      "nav.services": "Services", "nav.works": "Projects", "nav.about": "About",
      "nav.process": "How it works", "nav.testimonials": "Reviews",
      "nav.contact": "Contact", "nav.cta": "Free estimate",

      "hero.eyebrow": "Masonry • Pavers • Concrete",
      "hero.title": "Masonry work built to <span class=\"hl\">last</span> for generations.",
      ...
      "hero.trust": "Serving Monmouth County, NJ · Free estimates · Quality craftsmanship",
      ...
      "form.note": "By submitting, you agree to be contacted about your estimate request.",
      ...
      "form.statusNoEp": "⚠️ Form not connected yet. Set up Web3Forms in assets/js/main.js. For now, please use WhatsApp.",
      ...
      "reels.btn": "View on Instagram", "reels.sound": "Toggle sound",
      "reels.prev": "Previous video", "reels.next": "Next video",
      "reels.soon": "Video coming soon",

      "aria.whats": "Chat on WhatsApp", "aria.toTop": "Back to top",
      "aria.menu": "Open menu", "aria.lang": "Select language",
    ...
    pt: {
      ...
      "nav.services": "Serviços", "nav.works": "Projetos", "nav.about": "Sobre",
      "nav.process": "Como funciona", "nav.testimonials": "Depoimentos",
      "nav.contact": "Contato", "nav.cta": "Orçamento grátis",

      "hero.eyebrow": "Masonry • Pavers • Concreto",
      "hero.title": "Trabalho em pedra e concreto feito para <span class=\"hl\">durar</span> gerações.",
      ...
      "hero.trust": "Atendemos Monmouth County, NJ · Orçamento grátis · Acabamento de qualidade",
      ...
      "form.note": "Ao enviar, você concorda em ser contatado sobre o seu pedido de orçamento.",
      ...
      "form.statusNoEp": "⚠️ Formulário ainda não conectado. Configure o Web3Forms em assets/js/main.js. Por enquanto, use o WhatsApp.",
      ...
      "reels.btn": "Ver no Instagram", "reels.sound": "Ativar/desativar som",
      "reels.prev": "Vídeo anterior", "reels.next": "Próximo vídeo",
      "reels.soon": "Vídeo em breve",

      "aria.whats": "Falar no WhatsApp", "aria.toTop": "Voltar ao topo",
      "aria.menu": "Abrir menu", "aria.lang": "Selecionar idioma",
    ...
    es: {
      ...
      "nav.services": "Servicios", "nav.works": "Proyectos", "nav.about": "Nosotros",
      "nav.process": "Cómo funciona", "nav.testimonials": "Opiniones",
      "nav.contact": "Contacto", "nav.cta": "Presupuesto gratis",

      "hero.eyebrow": "Masonry • Pavers • Concreto",
      "hero.title": "Trabajo en piedra y concreto hecho para <span class=\"hl\">durar</span> generaciones.",
      ...
      "hero.trust": "Servimos Monmouth County, NJ · Presupuesto gratis · Acabado de calidad",
      ...
      "form.note": "Al enviar, acepta ser contactado sobre su solicitud de presupuesto.",
      ...
      "form.statusNoEp": "⚠️ Formulario aún no conectado. Configure Web3Forms en assets/js/main.js. Por ahora, use WhatsApp.",
      "form.sending": "Enviando...",
      ...
      "reels.handle": "pfmasonry", "reels.follow": "Seguir",
      "reels.btn": "Ver en Instagram", "reels.sound": "Activar/desactivar sonido",
      "reels.prev": "Video anterior", "reels.next": "Video siguiente",
      "reels.soon": "Video próximamente",

      "aria.whats": "Hablar por WhatsApp", "aria.toTop": "Volver arriba",
      "aria.menu": "Abrir menú", "aria.lang": "Seleccionar idioma",
